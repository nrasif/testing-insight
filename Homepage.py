...
def render_homepage():
    ...
    img_better_view = get_image_as_base64("assets/testinginsight.png")
                ...
                <div class="grid-row grid-row-1">
                    <div class="modern-feature-card">
                        ...
                        <div class="image-container">
                            <img src="data:image/png;base64,{img_offline_mode}" alt="Offline Mode & Security">
                        </div>
                    </div>
                    <div class="modern-feature-card">
                        ...
                        <div class="image-container">
                            <img src="data:image/png;base64,{img_better_view}" alt="Better Jira View">
                        </div>
                    </div>
                </div>
